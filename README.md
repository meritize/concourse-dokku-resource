...
* `nginx`: *Optional.* An object whose key-value pairs will be set as nginx configuration
   (https://dokku.com/docs/networking/proxies/nginx/#setting-properties-for-the-nginx-config) for the app.
